...
public class TicTacToe implements ActionListener {
	...
	TicTacToe() {
		...
		//For Restart Button
		b.setBounds(500, 0, 90, 100);
		b.setFont(new Font("MV Boli",Font.PLAIN, 20));
		...
		title_panel.setBounds(0, 0, 400, 200);
		
		button_panel.setLayout(new GridLayout(3,3));
		button_panel.setBackground(new Color(160, 150, 140));
		...
		title_panel.add(b, BorderLayout.EAST);
		title_panel.add(text, BorderLayout.WEST);
	...
	public void draw() {
		...
		for(int i=0;i<9;++i) {
			button[i].setBackground(new Color(200, 0, 0));
			button[i].setEnabled(false);
		}
	}
	...
	public void reset() {
		...
		//new TicTacToe(); //this logic always creates a new window
